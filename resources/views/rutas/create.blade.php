...
@section('content')
    ...
    <div>
        <div class="row">        
          ...
          <form action="{{url('/admin/sectores')}}/{{$sector->id}}/rutas" method="post" class="form-content fadeIn animated">
            {{ csrf_field() }}
                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Sector</label>
                                    <input type="text" name="sector_nombre" class="form-control" value="{{$sector->nombre}}" readOnly>
